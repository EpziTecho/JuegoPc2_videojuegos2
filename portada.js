document.addEventListener("DOMContentLoaded", function () {
    ...
    var estadoPortada = {
        preload: function () {
            juego.load.spritesheet("fondo", "img/fondo-semana4.png", 640, 800, 17); // Cargar la hoja de sprites
        ...
        create: function () {
            ...
            var botonJugar = juego.add.button(x - 20, y, "boton", this.iniciarJuego, this, 2, 1, 0);
            ...
            var botonSeleccionar = juego.add.button(juego.world.centerX, botonJugar.y + botonJugar.height + distanciaEntreBotones, "boton_seleccionar", this.seleccionarPersonaje, this, 2, 1, 0);
            ...
            var botonPlayer1 = juego.add.button(juego.world.centerX, botonSeleccionar.y + botonSeleccionar.height + distanciaEntreBotones, "boton_player1", this.iniciarPlayer1, this, 2, 1, 0);
            ...
            var botonPlayer2 = juego.add.button(juego.world.centerX, botonPlayer1.y + botonPlayer1.height + distanciaEntreBotones, "boton_player2", this.iniciarPlayer2, this, 2, 1, 0);
            ...
            var botonCreditos = juego.add.button(juego.world.centerX, botonPlayer2.y + botonPlayer2.height + distanciaEntreBotones, "boton_creditos", this.mostrarCreditos, this, 2, 1, 0);
            ...
            var texto = juego.add.text(juego.world.centerX, juego.world.height - 20, "Diseñado por Sergio Alexander Huayllas ©", {
            ...
            var titulo = juego.add.text(juego.world.centerX, 100, "Space Shooter", {
            ...
            var spritePersonaje = juego.add.sprite(juego.world.centerX, juego.world.centerY - 150, "personaje" + (parseInt(personajeSeleccionado) + 1));
